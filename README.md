...
reconweb_version=$(git rev-parse --abbrev-ref HEAD)-$(git describe --tags)
...
AXIOM_FLEET_NAME="reconWEB"
AXIOM_FLEET_COUNT=5
AXIOM_FLEET_REGIONS="eu-central"
AXIOM_FLEET_SHUTDOWN=true
# This is a script on your reconweb host that might prep things your way...
